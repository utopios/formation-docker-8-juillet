...
###
docker run -d --name postgres --network bridge-slide-21 -e POSTGRES_PASSWORD="ChangeMe" -e POSTGRES_USER="symfony" -e POSTGRE_DB="app" -v data-postgres:/var/lib/postgresql/data postgres
